...
def extract_memory(user_text: str, brahma_text: str, api_key: str = "") -> dict:
    try:
        ...
        raw = client.chat(
            ...
            f"                  (e.g. mark_xxv: 'Building a Karen assistant')\n"
            ...
            f"- Extract from BOTH user and Karen turns.\n"
            ...
            f' "projects":{{"mark_xxv":{{"value":"Karen assistant"}}}},\n'
